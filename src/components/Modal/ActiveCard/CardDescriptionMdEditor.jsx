...
//   **Hello world | QuangNguyenDev - Một Lập Trình Viên | Trello MERN Stack Advanced**
...
function CardDescriptionMdEditor({
  ...
  const [cardDescriptionState, setCardDescriptionState] =
    useState(cardDescription)

  const updateCardDescription = () => {
    setMarkdownEditMode(false)
    handleUpdateCardDescription(cardDescriptionState)
  }
      ...
      {markdownEditMode ? (
        <Box sx={{ mt: 5, display: "flex", flexDirection: "column", gap: 1 }}>
          <Box data-color-mode={mode}>
            <MDEditor
              value={cardDescriptionState}
              onChange={setCardDescriptionState}
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <Box data-color-mode={mode}>
            <MDEditor.Markdown
              source={cardDescriptionState}
              style={{
                whiteSpace: "pre-wrap",
                padding: cardDescriptionState ? "10px" : "0px",
                border: cardDescriptionState
